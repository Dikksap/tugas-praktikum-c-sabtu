...
void motor_tungkai() {
    printf("2.Motor tungkai berputar 45 derajat.\n");
...
void motor_jari() {
    printf("3.Motor jari mendekati objek.\n");
    
    usleep(1000000); 
}

void proses_pengelasan(int ketebalan, int waktu) {
    printf("4.Pengelasan dengan ketebalan %d mm, waktu: %d detik.\n\n", ketebalan, waktu);
...
int main() {
    ...
    for (int i = 0; i < jumlahKetebalan; i++) {
        ...
        printf("1.Motor utama pindah ke titik nilai tengah %d mm.\n", nilaiTengah);
